...
const Hero = () => {
  return (
    <div className="flex flex-col h-screen max-h-[537px] text-center justify-center mx-auto w-full p-4">
      <div className="main-content mb-4">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white opacity-80">
          Unlok Dev is the ultimate <br className="hidden lg:block" /> solution
          for developers.
        </h1>
      </div>
      <div className="child-content mb-8">
        <p className="text-md md:text-lg text-gray-400">
          ...
          <br className="hidden lg:block" /> using our toolkit to drive
